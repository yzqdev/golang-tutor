...
const Config = {
  ...
  serverUrl: getVariableValue("LANG_SERVER", "http://localhost:8080"), //default window.location.origin
  githubUrl: getVariableValue(
    "GITHUB_URL",
    "https://github.com/x1unix/go-playground"
  ),
  issueUrl: getVariableValue(
    "ISSUE_URL",
    "https://github.com/x1unix/go-playground/issues/new"
  ),
  donateUrl: getVariableValue(
    "DONATE_URL",
    "https://opencollective.com/bttr-go-playground"
  ),
  ...
  get runtimeType(): RuntimeType {
    ...
    return this.getValue<RuntimeType>(
      RUNTIME_TYPE_KEY,
